...
public class JwtUtils {
    ...
    public static String generateToken(Map<String, Object> map, PrivateKey key) throws Exception {
        return Jwts.builder()
                .setClaims(map)
                .setExpiration(DateTime.now().plusMinutes(60*60*24).toDate())
                .signWith(key, SignatureAlgorithm.RS256)
                .compact();
    }

    public static String generateToken(Map<String, Object> map) throws Exception {
        return Jwts.builder()
                .setClaims(map)
                .setExpiration(DateTime.now().plusMinutes(60*60*24).toDate())
                .compact();
